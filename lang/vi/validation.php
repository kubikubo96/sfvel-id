...
return [
    'phone_number' => 'Số điện thoại không đúng định dạng. Vui lòng thử lại!',
    'identity_card_number' => 'Trường :attribute không đúng định dạng.',
    ...
    'array_keys_in_list' => 'Trường :attribute phải là một mảng với các keys sau: :list',
    'array_keys_invalid' => 'Trường :attribute chứa keys không hợp lệ: :list',
    ...
    'date_or_datetime' => 'Trường :attribute phải là một ngày hoặc thời gian hợp lệ.',
    ...
    'enum' => 'Trường :attribute không hợp lệ.',
    'attributes' => [
        'address' => 'địa chỉ',
        'age' => 'tuổi',
        'available' => 'có sẵn',
        ...
        'year' => 'năm',
        'job_id' => 'vị trí ứng tuyển',
        'province_id' => 'tỉnh',
        'district_id' => 'huyện',
        'front' => 'ảnh mặt truớc',
        'back' => 'ảnh mặt sau',
        'left_face' => 'ảnh khuôn mặt bên trái',
        'front_face' => 'ảnh khuôn mặt chính diện',
        'right_face' => 'ảnh khuôn mặt bên phải',
        'card_id' => 'số CMND/CCCD',
        'ethnic' => 'dân tộc',
        ...
        'resident_address_detail' => 'địa chỉ thường trú chi tiết',
        'current_address_province' => 'chỗ ở hiện tại Tỉnh/Tp',
        'current_address_district' => 'chỗ ở hiện tại Quận/huyện',
        'current_address_sub_district' => 'chỗ ở hiện tại Phường/xã',
        'current_address_detail' => 'chỗ ở hiện tại chi tiết',
